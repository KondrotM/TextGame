...
spawn = Room("A COLLAPSED TUNNEL",["YOU SURVEY YOUR SURROUNDINGS. THE TUNNEL TO THE CAVE YOU ENTERED HAS COLLAPSED, LEAVING YOU ON YOUR OWN."],[],[],"perm",[items.potionH])
enemyC = Room("A CRAMPED CORRIDOR",["YOU THROUGH SQUEEZE INTO WHAT SEEMS TO BE AN OLD TUNNEL LEFT BY MINERS","IT'S DARK, AND DAMP."],[],[enemies.orc,enemies.bat,enemies.slime],"temp",[])
